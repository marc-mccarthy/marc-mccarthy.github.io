...
('Greener Foot(prints): Road Trip Edition', '/wireframes/greener-footprints-wireframe.png', '🍃 Travel emissions footprint calculator based on variables integrated with many features.', 'https://greener-footprints.herokuapp.com', 'https://github.com/marc-mccarthy/greener-footprints'),
